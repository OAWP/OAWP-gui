...
/**
 * @brief Find UI file in the system
 *
 * @note When compiling with the DEBUG definition, the UI files will be searched
 * on ./assets/ui. Otherwise, they will be searched based on the XDG_DATA_DIRS
 * environment variable when using a POSIX OS.
 *
 * @param filename The UI filename to search.
 *
 * @return The path for the target UI file.
 */
